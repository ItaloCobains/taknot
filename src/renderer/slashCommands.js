...
export const SLASH_COMMANDS = [
  ...
  },
  {
    ...
    label: 'Alert Note',
    hint: '[!NOTE]',
    keywords: ['alert', 'note', 'github', 'callout', 'admonition'],
    insert: '> [!NOTE]\n> ',
    cursor: 12,
  },
  {
    ...
    label: 'Alert Tip',
    hint: '[!TIP]',
    keywords: ['alert', 'tip', 'github', 'callout', 'hint'],
    insert: '> [!TIP]\n> ',
    cursor: 11,
  },
  {
    ...
    hint: '[!IMPORTANT]',
    keywords: ['alert', 'important', 'github', 'callout'],
    insert: '> [!IMPORTANT]\n> ',
    cursor: 17,
  },
  {
    ...
    label: 'Alert Warning',
    hint: '[!WARNING]',
    keywords: ['alert', 'warning', 'github', 'callout', 'warn'],
    insert: '> [!WARNING]\n> ',
    cursor: 15,
  },
  {
    ...
    label: 'Alert Caution',
    hint: '[!CAUTION]',
    keywords: ['alert', 'caution', 'github', 'callout', 'danger'],
    insert: '> [!CAUTION]\n> ',
    cursor: 15,
  },
  {
